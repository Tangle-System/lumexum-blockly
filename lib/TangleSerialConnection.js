...
//     const bytes = [...numberToBytes(123456789, 4), ...numberToBytes(payload.length, 4), ...payload];
//     const timeout = 25;
...
//     const payload = [...numberToBytes(timestamp, 4)];
//     const bytes = [...numberToBytes(987654321, 4), ...numberToBytes(payload.length, 4), ...payload];
