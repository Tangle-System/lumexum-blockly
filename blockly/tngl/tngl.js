...
Blockly.Tngl.init = function (workspace) {
  ...
  if (defvars.length) {
    Blockly.Tngl.definitions_["variables"] = "var " + defvars.join(", ") + ";";
  }
};
...
Blockly.Tngl.scrub_ = function (block, code, opt_thisOnly) {
  ...
  if (!block.outputConnection || !block.outputConnection.targetConnection) {
    ...
    if (comment) {
      comment = Blockly.utils.string.wrap(comment, Blockly.Tngl.COMMENT_WRAP - 3);
 ...
 */
Blockly.Tngl.getAdjusted = function (block, atId, opt_delta, opt_negate, opt_order) {
  ...
  if (delta > 0) {
    var at = Blockly.Tngl.valueToCode(block, atId, Blockly.Tngl.ORDER_ADDITION) || defaultAtIndex;
  } else if (delta < 0) {
    var at = Blockly.Tngl.valueToCode(block, atId, Blockly.Tngl.ORDER_SUBTRACTION) || defaultAtIndex;
  } else if (opt_negate) {
    var at = Blockly.Tngl.valueToCode(block, atId, Blockly.Tngl.ORDER_UNARY_NEGATION) || defaultAtIndex;
  } else {
    var at = Blockly.Tngl.valueToCode(block, atId, order) || defaultAtIndex;
  }
